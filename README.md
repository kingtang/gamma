...
- Pipeline&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;数据管道被ServiceEngine集成能够实现数据在Pipeline中的双向流动，其中pipeline中的每个数据处理节点称&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;为一个Handler，支持在已有的pipeline中扩展自定义Handler
